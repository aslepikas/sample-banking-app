package net.slepikas.banking.db.config;
...
@EnableJpaRepositories(
        basePackageClasses = {AccountEventRepository.class, AccountRepository.class, CustomerRepository.class})
public class RepoFactoryForTest {
    @Bean
